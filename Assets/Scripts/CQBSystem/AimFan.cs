...
public class AimFan : MonoBehaviour
{
    ...
    public float spreadAngle = 120f; // The spread angle of the weapon
    public int rayCount = 128; // How many rays to cast within the spread cone
    ...
    void DrawSpreadIndicator()
    {
        ...
        float stepAngle = 2*spreadAngle / (float)(rayCount - 1);
